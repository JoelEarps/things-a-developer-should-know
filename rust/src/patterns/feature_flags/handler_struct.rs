...
impl AppComponentManager {
    pub fn new() -> Self {
        ...
        let streamer: Box<dyn Streamer + Send + Sync> = {
            ...
            {
                use crate::patterns::feature_flags::feature_flags_functionality_one::KafkaStreamer;
            ...
            {
                use crate::patterns::feature_flags::feature_flags_functionality_two::NoopStreamer;
